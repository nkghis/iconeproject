                        ...
                        @if (Auth::check())
                           ...
                           {{-- @can('view_diplomes')
                            ...
                            @endcan
                                ...
                                @can('view_visuels', 'add_visuels', 'edit_visuels', 'delete_visuels')
                                    <li class="nav-link {{ Request::is('visuels*') ? 'active' : '' }}">
                                        <a href="{{ route('visuels.index') }}">
                                            <i class="material-icons">photo</i> Visuel
                                        </a>
                                    </li>
                                @endcan

                                @can('view_maps', 'add_maps', 'edit_maps', 'delete_maps')
                                    <li class="nav-link {{ Request::is('map*') ? 'active' : '' }}">
                                        <a href="{{ route('maps.index') }}">
                                            <i class="material-icons">place</i> Carte
                                        </a>
                                    </li>
                                @endcan
